                  ...
                  <b-col cols="12">
                    <div class="text-center">
                      <h5 class="h5 text-gray-900 mb-2">
                        {{ $t( "Kripto Paranızı Borsamızda Sergilemek Bizimle İletişime Geçin" ) }}
                      </h5>
                    </div>
                    ...
                    <b-form-group :label="$t('Ekstra Bilgi')">
                      <b-form-textarea v-model="form['info']" :placeholder="$t('Ekstra bilgileri giriniz')" rows="5" ></b-form-textarea>
                    </b-form-group>
                    <div class="d-grid gap-2">
                      <b-button block type="submit" variant="primary">{{ $t("Kaydet") }}</b-button>
                    </div>
                  </b-col>
                </b-row>
              </b-card-body>
