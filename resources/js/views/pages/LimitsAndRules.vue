    ...
    <div id="section0" class="invented-container overflow-hidden">
        <b-container>
            <b-row class="invented-area pt-70 pb-40 mb-pt-45 justify-content-between">
                <b-col cols="12">
                    <h1 class="text-center mb-5">Limitler ve Kurallar</h1>
                    <b-row>
                        <b-col cols="12" md="6" class="float-left">
                            <h6 class="fw-bolder">Bitcoin Cüzdanı Aktif Değil</h6>
                            <table class="table table-responsive table-bordered table-striped ">
                                ...
                                <tr>
                                    <td>24 Saat Türk Lirası</td>
                                    <td align="right">1,000,000.00 TL</td>
                                </tr>
                                <tr>
                                    <td>30 Gün Türk Lirası</td>
                                    <td align="right">5,000,000.00 TL</td>
                                </tr>
                                <tr>
                        ...
                        <b-col cols="12" md="6" class="float-left">
                            <h6 class="fw-bolder">Bitcoin Cüzdanı Aktif</h6>
                            <table class="table table-responsive table-bordered table-striped ">
                                <tbody>
                                <tr>
                                    <td colspan="2" class="fw-bolder">Para Yatırma</td>
                    ...
                    <p>Tek seferde en fazla 100,000 TL’lik Bitcoin alabilirsiniz.</p>
                    <p>
                        Alım işleminiz gerçekleştikten sonra tekrar Bitcoin alabilirsiniz.
                    </p>
                    <h5>Bitcoin Satma Kuralları</h5>
                    <p>En az 0.0005 BTC satabilirsiniz.</p>
                    <p>Tek seferde en fazla 0.5 BTC satabilirsiniz.</p>
                    <p>
                        Satım işleminiz gerçekleştikten sonra tekrar Bitcoin satabilirsiniz.
                    </p>
                </b-col>
            </b-row>
        </b-container>
