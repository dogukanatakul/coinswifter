                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-center">
                                    <h5 class="h5 text-gray-900 mb-2">{{ type }} {{ $t('Doğrulama') }}</h5>
                                    <hr>
                                </div>
                                ...
                                <div class="text-center">
                                    <b-button :disabled="sendCodeButton" @click="sendCode" squared variant="success" size="sm">{{ sendCodeMsg }}</b-button>
                                </div>
...
export default {
    ...
    methods: {
        async signin() {
            ...
            await restAPI.getData({Action: "verification-control"}, this.form).then((response) => {
