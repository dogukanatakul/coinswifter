                ...
                <div class="card o-hidden border-0 shadow-lg my-5 p-4">
                    <div class="card-body p-0">
                        ...
                        <div class="row justify-content-between py-0 py-md-4">
                            <div class="col-12 col-md-4 text-md-start d-grid gap-2 py-2 py-md-0">
                                <b-button squared block variant="outline-secondary" :to="{name:'forgot'}">{{ $t('Şifremi unuttum?') }}</b-button>
                            </div>
                            <div class="col-12 col-md-4 text-md-end d-grid gap-2 py-2 py-md-0">
                                <b-button squared block variant="outline-secondary" :to="{name:'signup'}">{{ $t('Yeni hesap oluştur!') }}</b-button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        async signin() {
            ...
            await restAPI.getData({Action: "signin"}, this.form).then((response) => {
