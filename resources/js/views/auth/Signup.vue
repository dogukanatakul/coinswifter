<template>
                ...
                <div class="card o-hidden border-0 shadow-lg my-5 p-4">
                    <div class="card-body p-0">
                                ...
                                <b-form @submit="register">
                                    <b-row>
                                        ...
                                        <b-col cols="12" md="6">
                                            <b-form-group :label="$t('Soyadınız')">
                                                <b-form-input v-model="form['surname']" type="text"
                                        ...
                                        <b-col cols="12" md="6">
                                            <b-form-group :label="$t('Doğum Tarihiniz')">
                                                <v-date-picker v-model="form.birthday" :masks="dateInputMask"
                                                               :model-config="dateModelMask" is-required>
                                                    <template v-slot="{ inputValue, inputEvents }">
                                                        <input class="form-control w-100" :value="inputValue"
                                                               :placeholder="$t('Gün-Ay-Yıl')" v-on="inputEvents"
                                                               v-maska="'##-##-####'"/>
                                                    </template>
                                                </v-date-picker>
                                        ...
                                        <b-col cols="12" md="6">
                                            <b-form-group :label="$t('Uyruğunuz')">
                                                <v-select v-model.number="form['nationality']" label="text"
                                                          :options="nationalities"
                                                          :reduce="(data) => data.value"></v-select>
                                                <b-form-text v-if="v$.form.nationality.$error"
                                        ...
                                        <b-col v-if="form['nationality'] === 218" cols="12">
                                            <b-form-group :label="$t('T.C. Kimlik Numaranız')">
                                                <b-form-input v-model="form['tck_no']" type="number"
                                                              :placeholder="$t('T.C. Kimlik Numaranız')"
                                                              inputmode="number"></b-form-input>
                                        ...
                                        <b-col v-if=" form['nationality'] !== 218 && form['nationality'] !== null "
                                               cols="12">
                                            <b-form-group :label="$t('Pasaport Numaranız')">
                                                <b-form-input v-model="form['pasaport_no']" type="text"
                                        ...
                                        <b-col cols="12" md="6">
                                            <b-form-group :label="$t('Telefon Kodunuz')">
                                                <v-select v-model.number="form['country_code']" label="text"
                                                          :options="phoneCodes"
                                                          :reduce="(data) => data.value"></v-select>
                                            </b-form-group>
                                        </b-col>
                                        <b-col cols="12" md="6">
                                            <b-form-group :label="$t('Telefon Numaranız')">
                                                <b-form-input v-model="form['telephone']" :key="formInputKey"
                                                              type="text" placeholder="53XXXXX"
                                                              inputmodde="tel"></b-form-input>
                                        ...
                                        <b-col cols="12" md="12">
                                            <b-form-group :label="$t('Şifreniz Tekrar')">
                                                <b-form-input v-model="form.password_repeat"
                                                              :placeholder="$t('Şifreniz Tekrar')" type="password"
                                                              inputmode="text"></b-form-input>
                                                <b-form-text v-if="v$.form.password_repeat.$error"
                                                             class="text-danger-custom">
                                                    <p class="text-danger-custom">
                                    ...
                                    <v-row>
                                        <b-col cols="12" class="py-2">
                                            <b-form-checkbox v-model="form['user_agreement']" required>
                                                <a href="javascript:"
                                                   @click=" contract.visible = true; contract.key = 'lighting_text'; ">{{
                                                        $t("sozlesme_1")
                                                    }}</a>
                                                {{ $t("sozlesme_2") }}
                                                <a href="javascript:"
                                                   @click=" contract.visible = true; contract.key = 'usage_contract'; ">{{
                                                        $t("sozlesme_3")
                                                    }}</a>
                                                {{ $t("sozlesme_4") }}
                                                <a href="javascript:"
                                                   @click=" contract.visible = true; contract.key = 'business_conditions'; ">{{
                                                        $t("sozlesme_5")
                                                    }}</a>{{ $t("sozlesme_6") }}
                                            </b-form-checkbox>
                                            <b-form-text v-if="v$.form.user_agreement.$error"
                                                         class="text-danger-custom">
                                                <p class="text-danger-custom">
                                        ...
                                        <b-col cols="12" class="py-2">
                                            <b-form-checkbox v-model="form['open_consent']" required>
                                                <a href="javascript:"
                                                   @click=" contract.visible = true; contract.key = 'open_consent'; ">{{
                                                        $t("sozlesme_7")
                                                    }}</a>{{ $t("sozlesme_8") }}
                                            </b-form-checkbox>
                                    ...
                                    <div class="d-grid gap-2">
                                        <b-button block type="submit" variant="primary">
                                            {{ $t("Hesap Oluşturma İşlemini Tamamla") }}
                                        </b-button>
                                    </div>
                                </b-form>
                            </div>
                        ...
                        <div class="row justify-content-center py-0 py-md-4">
                            <div class="col-12 col-md-4 text-md-end d-grid gap-2 py-2 py-md-0 w-100">
                                <b-button squared block variant="outline-secondary" :to="{ name: 'signin' }">
                                    {{ $t("Zaten Hesabım Var") }}
                                </b-button>
                            </div>
                        </div>
    ...
    <Dialog v-model:visible="contract.visible" :breakpoints="{ '2000px': '75vw', '640px': '100vw' }">
        ...
        <template #footer>
            <div class="d-grid gap-2">
                <b-button block @click="contract.visible = false" variant="success">{{
                        $t("Okudum ve Anladım")
                    }}
                </b-button>
            </div>
