                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-12">
                                <div class="text-center">
                                    <h5 class="h5 text-gray-900 mb-2">{{ $t('Hesap Oluştur') }}</h5>
                                    <hr>
                                </div>
                                <b-form @submit="register">
                                    <b-row>
                                        ...
                                        <b-col v-if="form['nationality']!==218 && form['nationality']!==null" cols="12">
                                            <b-form-group
                                                :label="$t('Pasaport Numaranız')"
                                            >
                                                <b-form-input
                                                ...
                                                <b-form-text v-if="v$.form.pasaport_no.$error">
                                                    <p class="text-danger">{{ $t('Lütfen pasaport numaranızı giriniz!') }}</p>
                                                </b-form-text>
                                            </b-form-group>
                                        </b-col>
                                        <b-col cols="12">
                                        ...
                                        <b-col cols="12">
                                            ...
                                            >
                                                ...
                                                <b-form-text v-if="v$.form.username.$error" class="text-danger">
                                                    ...
                                                    <p class="text-danger">{{ $t('En az 8 karakterli bir kullanıcı adı oluşturunuz!') }}</p>
                                                    <p class="text-danger">{{ $t('Metinsel ifade ve sonuna sadece rakamsal ifadeler kabul edilir.') }}</p>
                                                    <p>
                                                        {{ $t('Doğru Örnek:') }} <b class="text-success">coinswifter01</b> | {{ $t('Yanlış örnekler:') }} <b class="text-danger">01coin</b> - <b class="text-danger">@coin</b> - <b class="text-danger">coin01swifter</b>
                                                    </p>
                                                </b-form-text>
                                            </b-form-group>
                                        </b-col>
                        ...
                        <div class="row justify-content-center py-0 py-md-4">
                            <div class="col-12 col-md-4 text-md-end d-grid gap-2 py-2 py-md-0">
                                <b-button squared block variant="outline-secondary" :to="{name:'signin'}">{{ $t('Zaten Hesabım Var') }}</b-button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    watch: {
        'form.telefon'(val) {
            if ((val === "0" || val === 0 || val === "+") && this.form['country_code'] === 218) {
                this.$notify({text: $t('Telefon numaranızı 555XXXXXX formatında yazınız.'), type: 'error'});
                this.form.telefon = ""
                this.formInputKey += 1
            }
        }
    ...
    methods: {
        async register() {
            ...
            await restAPI.getData({Action: "signup"}, this.form).then((response) => {
