                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-center">
                                    <h5 class="h5 text-gray-900 mb-2">{{ $t('Şifremi Unuttum!') }}</h5>
                                    <hr>
                                </div>
                                <b-form @submit="forgot">
                                    ...
                                    <div class="d-grid gap-2">
                                        <b-button block type="submit" variant="primary">{{ sendBtnMessage }}</b-button>
                                    </div>
                                </b-form>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        async forgot() {
            ...
            await restAPI.getData({Action: "forgot-password"}, this.form).then((response) => {
