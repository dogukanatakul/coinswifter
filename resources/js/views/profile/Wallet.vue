  ...
  <div class="wallet p-3">
    <b-row class="" v-on:scroll.passive="handleScroll" ref="handleScroll">
      <b-col cols="12" class="px-auto d-lg-none">
        <div class="border myRounded text-sm-center xs-center mx-auto my-5 myDiv bg-white-custom" @click="walletSelected('account_status')" :active="walletSelect === 'account_status'" >
